...
function structuredQueryReducer(initialState, expectedTarget) {
  return function structuredQueryReducer(state = initialState, action) {
...
export default combineReducers({
  ...
  structuredQuery: structuredQueryReducer(initialStructuredQuery, 'query'),
  structuredHighlight: structuredQueryReducer(initialStructuredHighlight, 'highlight'),
